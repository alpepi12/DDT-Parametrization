...
function [breakout_f, dimensions] = breakout_force(heap_capacity,...
    ...
    breakout_f = (F_s + F_r)/1000;       %kN
    
    %Log Entries
    log_entry = "******** Bucket Breakout Force ********\n"; %Initialize log entry string array
    log_entry = [log_entry; strcat("Breakout Force: ", string(breakout_f), " kN \n")];
    log_entry = [log_entry; "**************************************\n"];
